# Huatulco content enrichment sources

This source map records the public sources used for the Huatulco bay and itinerary depth pass.

## Core public sources

1. Oaxaca Travel — Huatulco Bays
   - URL: https://www.oaxaca.travel/index.php/en-us/all-destinations/huatulco-bays-en
   - Used for: nine-bay framing, 35 km coastline context, 36 beaches, Huatulco National Park overview, HUX airport context, and nature-tourism activity categories.
   - Copy rule: use as background facts only; rewrite in original Top Huatulco voice.

2. CONANP / Gobierno de México — Parque Nacional Huatulco
   - URL: https://www.gob.mx/conanp/documentos/parque-nacional-huatulco
   - Used for: protected-area framing, responsible tourism rules, boat-access guidance, Huatulco National Park ecology, marine/terrestrial ecosystem context, and same-week verification prompts.
   - Copy rule: avoid hard-coding volatile fees/hours as final advice; tell visitors to verify current rules before boat/national-park visits.

3. CONANP Protected Areas — Huatulco National Park
   - URL: https://descubreanp.conanp.gob.mx/swb/conanp/ANP?suri=69
   - Used for: park context, La Crucecita proximity, general services nearby, climate/rainy-season context, trails/interpretation, and responsible visitor guidance.
   - Copy rule: use for context and current-check links; do not present old scraped schedules or fees as guaranteed.
...
- Treat swimming and snorkeling as condition-dependent, not guaranteed by bay name.
